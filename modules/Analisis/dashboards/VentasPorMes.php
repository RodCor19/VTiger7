...
Class Analisis_VentasPorMes_Dashboard extends Vtiger_IndexAjax_View{
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->view('VentasPorMes_Dash.tpl', $request->getModule());
	}
	...
	public function getAjax(Vtiger_Request $request){
		...
		$moduleModel = Vtiger_Module_Model::getInstance("Analisis");
		$respuesta = $moduleModel->getVentasPorMes($request);
