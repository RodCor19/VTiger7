...
Class Analisis_VentasPorDia_Dashboard extends Vtiger_IndexAjax_View{
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->assign('dashboard', true);
		$viewer->assign('SCRIPTS',$this->getHeaderScripts($request));

		$viewer->view('VentasPorDia_Dash.tpl', $request->getModule());
	}
	...
	public function getAjax(Vtiger_Request $request){
		...
		$moduleModel = Vtiger_Module_Model::getInstance("Analisis");
		$respuesta = $moduleModel->getVentasPorDia($request);
