...
class Analisis_Beneficios_Dashboard extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$first_day_this_month = date('01-m-Y', strtotime("-1 year"));
		...
		$viewer->view('Beneficios_Dash.tpl', $request->getModule());
	}
