...
class Analisis_Morosidad_View extends Vtiger_Index_View {
...
//Cuentas
			$cuentas = array();
			$sql="SELECT DISTINCT cod_cta, nom_cta FROM lp_saldoscontables where cod_cta in(11305,11310,11313,11314,11365) order by nom_cta";
		...
		$viewer->view('MorosidadView.tpl', $request->getModule());
	}
