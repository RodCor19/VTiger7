...
class Analisis_ParetoCuentas_View extends Vtiger_Index_View {
	...
	protected function preProcessTplName(Vtiger_Request $request) {
		return 'ParetoCuentasViewPreProcess.tpl';
	}
	...
	public function process(Vtiger_Request $request) {
		...
		//$respuesta = $moduleModel->getParetoCuentas($request);
...
/*M E*/		$viewer->assign('locales', $locales);
		...
		$viewer->view('ParetoCuentasView.tpl', $request->getModule());
	}
