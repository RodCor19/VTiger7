...
class Analisis extends Vtiger_CRMEntity {
	...
	*/
	...
	function Analisis($view='',$data=Array())
	{
		$this->view = $view;
	...
	*/
	...
	var $table_name = 'vtiger_analisis';
	var $table_index= 'analisisid';
	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_analisiscf', 'analisisid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_analisis', 'vtiger_analisiscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_analisis' => 'analisisid',
		'vtiger_analisiscf'=>'analisisid');
	...
	var $list_fields = Array (
		...
		'<entityfieldlabel>' => Array('analisis', '<entitycolumn>'),
