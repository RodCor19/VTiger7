...
class Analisis_List_View extends Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$adb = PearDatabase::getInstance();
	 	...
	 	$query="SELECT destinatario,firstname,lastname,mobile,documento,asunto, DATE_FORMAT(fecha_error, '%d/%m/%Y') AS fecha_error
		...
		//FILTROS
			...
			//Programas
			$programas = array("Generico","Comprador Frecuente","Socio Afin","Los 1",
								"Socio J&J","Tarjeta Gaviotas","Administrativo","Funcionario","Proveedor","WTC Member",
								"Club de Golf","Gaviotas Electronicas","Gaviotas Efectivo");
			$programas[]="Sin Dato";
