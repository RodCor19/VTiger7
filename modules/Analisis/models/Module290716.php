	...
	public function getVentilacionClientes(Vtiger_Request $request) {
		...
		LOS 1, WTC Member,COMPRADOR FRECUENTE*/
		 ...
		 $query="
			...
			SUM(IF(programa LIKE '%Programas Gaviotas%' AND programa LIKE '%Funcionario%' ,1,0 )) AS gaviotas_funcionarios,
			...
			SUM(IF(lppromociones is not null and lppromociones!='NULL' AND programa LIKE '%Funcionario%' ,1,0 )) AS promociones_funcionarios,
		...
		if($no_of_rows>0){
			...
			$json_string="[[\"Programa\",\"Todas Personas\",\"Generico\",\"Comprador Frecuente\",\"Socio Afin\",\"Los 1\",
							\"Socio J&J\",\"Programas Gaviotas\",\"Administrativo\",\"Funcionario\",\"Proveedor\",\"WTC Member\",
...
/*M E*/		}	
	...
	public function getClientes(Vtiger_Request $request) {
		...
		if($mostrar_promociones){
				...
				bccontacto AS contacto, COUNT( bccontacto ) AS web
				...
				contacto, COUNT( contacto ) AS web
