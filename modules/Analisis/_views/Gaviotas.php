...
class Analisis_Gaviotas_View extends Vtiger_Index_View {
	...
	protected function preProcessTplName(Vtiger_Request $request) {
		return 'GaviotasViewPreProcess.tpl';
	}
	...
	public function process(Vtiger_Request $request) {
		...
		$first_day_this_month = date('01-m-Y', strtotime("-2 years"));
		$last_day_this_month  = date('t-m-Y');
		$date_range=$first_day_this_month.",".$last_day_this_month;
		$viewer->assign('date_range', $date_range);

		$viewer->view('GaviotasView.tpl', $request->getModule());
	}
