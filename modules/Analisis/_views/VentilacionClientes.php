...
class Analisis_VentilacionClientes_View extends Vtiger_Index_View {
	...
	protected function preProcessTplName(Vtiger_Request $request) {
		return 'VentilacionClientesViewPreProcess.tpl';
	}
	...
	public function process(Vtiger_Request $request) {
		...
		$respuesta = $moduleModel->getVentilacionClientes($request);
		...
		//Canal Activo
		$canales = array('Mall','Web','Redes','App Smartphone');
		$canales[]="Sin Dato";
		...
		//Programas
		$programas = array("Generico","Comprador Frecuente","Los 1",
							"Tarjeta Gaviotas","Funcionario","Proveedor","WTC Member",
							"Gaviotas Electronicas","Gaviotas Efectivo");
		$programas[]="Sin Dato";
		...
		$viewer->view('VentilacionClientesView.tpl', $request->getModule());
	}
