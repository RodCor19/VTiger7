...
class Analisis_ParetoClientes_View extends Vtiger_Index_View {
	...
	protected function preProcessTplName(Vtiger_Request $request) {
		return 'ParetoClientesViewPreProcess.tpl';
	}
	...
	public function process(Vtiger_Request $request) {
		...
		$viewer->view('ParetoClientesView.tpl', $request->getModule());
	}
