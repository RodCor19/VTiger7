...
-- Volcando datos para la tabla vtiger7.vtiger_crmentity: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_crmentity_user_field: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_inventorychargesrel: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_inventoryproductrel: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_invoice: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_invoicebillads: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_invoicecf: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_invoiceshipads: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_loginhistory: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_modtracker_basic: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_modtracker_detail: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_pbxmanager_phonelookup: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_productcf: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger7.vtiger_products: ~0 rows (aproximadamente)
