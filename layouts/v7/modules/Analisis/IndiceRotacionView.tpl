...
<div class="detailViewContainer">
  <div class="row-fluid detailViewTitle"  style="padding-bottom:10px;"><a href="index.php?module=Analisis&view=Deudores">Deudores</a>
    <span class="recordLabel font-x-x-large textOverflowEllipsis span pushDown" title="gika"><span class="">Índice de Rotación</span>&nbsp;</span>
...
function pushIfNew(obj) {
  ...
  $( document ).ready(function() {
    ...
    field_definitions = [
          ...
          {name: 'Facturacion Mensual Prom.',   type: 'float',    filterable: true, rowLabelable: true,displayFunction: function(value){ return accounting.formatNumber(value,0,milSep,decimalSep)}},
          {name: 'Rotacion (Meses)',   type: 'float',    filterable: true, rowLabelable: true,displayFunction: function(value){ return accounting.formatNumber(value,2,milSep,decimalSep)}},
  ...
  function graficar(){
    ...
    ////"Fecha", "Total Deuda", "Facturacion Mensual Prom.", "Rotacion (Meses)", "Orden"
    filas= ["Fecha", "Total Deuda", "Facturacion Mensual Prom.", "Rotacion (Meses)", "Orden"];
    nroOrden = 4;
    ordenNumerico=[1,2,3];
  ...
  function actualizar(){
    ...
    jQuery.ajax({
           async: false,
           data: {},
           url:  'index.php?module=Analisis&action=IndiceRotacion',
           dataType:"json",
