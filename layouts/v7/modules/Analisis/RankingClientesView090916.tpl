...
<div class="detailViewContainer">
  ...
  <div class="detailViewInfo row-fluid">
   ...
   <div class="row-fluid" style="padding-top:5px;">
    ...
    <span class="span3">
      <input type="text" name="createdtime" id="createdtime" class="dateRange widgetFilter dateField" data-date-format="dd-mm-yyyy">
    </span>
    <!--nuevo-->
    <span class="span3">
      <span class="pull-left" style="padding-left:10px;padding-top:5px;">
      ...
      "aoColumnDefs": [
              ...
              "fnServerParams": function ( aoData ) {
               ...
               aoData.push( {"name": "tipo", "value": tipo},{"name": "rango", "value": edad_str},{"name": "sexo", "value": sexo_str},
                ...
                ,{"name": "total_records", "value": total_records},{"name": "display_records", "value": display_records},{"name": "desde","value":desde},{"name": "hasta","value":hasta} );
             },
