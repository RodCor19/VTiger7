...
<div class="detailViewContainer">
  <div class="row-fluid detailViewTitle"  style="padding-bottom:10px;">
    ...
    <span class="recordLabel font-x-x-large textOverflowEllipsis span pushDown" title="gika"><span class="">Deuda Documentada</span>&nbsp;</span>
...
function pushIfNew(obj) {
  ...
  $( document ).ready(function() {
    ...
    field_definitions = [
          ...
          {name: 'Codigo',   type: 'string',   filterable: true, rowLabelable: true},
          {name: 'Vencimiento',   type: 'date',   filterable: true, rowLabelable: true},
  ...
  function graficar(){
    ...
    filas=['LUC','Codigo','Nombre Fantasía','Razón Social', 'Documento','Vencimiento','Importe','Total','Orden'];
            nroOrden=8;
            ordenNumerico=[6,7];
