...
{if $dashboard == false}
  ...
  </div><div class="row-fluid detailViewTitle"><span class="row-fluid"><span class="muted">¿Cu&aacute;nto vendemos por d&iacute;a?<br>Vista Pesos IPC: cada mes (día) del año N, solo se muestra la venta de los locales que ya vendían el mes (día) del año N-1<br>Perímetro:
  cada día del año N, solo se muestra la venta de los locales que ya vendían el día del año N-1
</span></span></div>
{/if}
...
{/literal}{/if}{literal}
        ...
        jQuery.ajax({
            async: false,
/*M E*/            data:  {'unidades':unidades, 'acumulado': acumulado, 'familia':familia, 'rubro':rubro, 'localizacion': localizacion, 'adherido':adherido, 'fecha':fecha, 'nombreLocal':nombreLocal, 'formapago':formapago,'perimetro': perimetro},
  ...
  function graficar(){
      ...
      chartexm1 = jQuery.jqplot('widgetChartContainerDia', chartData,
      { 
          animate: true,
          animateReplot: true,
          title:"Ventas", 
