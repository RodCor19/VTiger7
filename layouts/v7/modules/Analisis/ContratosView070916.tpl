...
function pushIfNew(obj) {
  ...
  function graficar(){
    ...
    switch(vista) {
        case 'actual':
            ...
            break;
        case 'resumen':
            filas=['Local','Min $','m2', 'Min $ / m2','Arr Prom Mensual ','Arr Prom / m2','Venta Contable ','VC/m2','Arr % ','Arr Total ','Arr Total / VC (%) ','Orden'];
            nroOrden=11;
  ...
  function actualizar(){
    ...
    jQuery.ajax({
           async: false,
           data: {'createdtime':createdtime,'familia':familia_str, 'rubro':rubro_str, 'localizacion': localizacion, 'adherido':adherido, 'nombreLocal':nombreLocal_str, 'vista':vista, 'm2':m2, 'agrupar':agrupar},
