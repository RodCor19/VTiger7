...
<script type="text/javascript">
  ...
  var field_definitions = [
          ...
          {name: 'Tarjeta Gaviotas',   type: 'string',   filterable: true, rowLabelable: true},
  ...
  var oTable=null;
  function graficar(){
      //'Programa', 'Todas Personas','Comprador Frecuente', 'Los 1',  'Tarjeta Gaviotas','Funcionario', 'WTC Member', 'Tarjeta Beneficios','Orden'
