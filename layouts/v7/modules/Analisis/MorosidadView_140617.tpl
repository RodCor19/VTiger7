...
function pushIfNew(obj) {
  ...
  $( document ).ready(function() {
    ...
    field_definitions = [
          ...
          {name: 'Deuda Vencida(Cliente/Total)',   type: 'float',    filterable: true, rowLabelable: true,displayFunction: function(value){ return accounting.formatNumber(value,0,milSep,decimalSep)}},
          {name: 'Acumulado',   type: 'float',    filterable: true, rowLabelable: true,displayFunction: function(value){ return accounting.formatNumber(value,0,milSep,decimalSep)}},
  ...
  function graficar(){
    ...
    filas=["Nro","Nombre Fantasía","Razón Social","Contrato","Deuda a Vencer",
  ...
  function actualizar(){
    ...
    jQuery.ajax({
           async: false,
           data: {'createdtime':createdtime, 'nombreLocal':nombreLocal_str },
