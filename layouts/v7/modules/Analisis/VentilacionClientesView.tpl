...
<script type="text/javascript">
  ...
  var field_definitions = [
          ...
          {name: 'Mi Shopping',   type: 'string',   filterable: true, rowLabelable: true},
          ...
          {name: 'Promociones',   type: 'string',   filterable: true, rowLabelable: true},
  ...
  var oTable=null;
  function graficar(){
      //'Programa', 'Todas Personas','Comprador Frecuente', 'Los 1',  'Programas Gaviotas','Mis Beneficios', 'WTC Member', 'Tarjeta Beneficios','Orden'
