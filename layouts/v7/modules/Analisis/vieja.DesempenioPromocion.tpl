    ...
    function actualizar(){
        ...
        for (i = 0;i <=promos.length;i++){
          ...
          if(i==0){
            ...
            series = [{
                lineWidth:4,highlighter: {formatString: yaxislblleg+' %s'},label:'<span style="color:'+eachcolor+'; border: 1px solid"> '+promos[i]+'</span>', yaxis: 'yaxis',
                }];
  ...
  function graficar(){
      ...
      { 
          ...
          axes:{
              xaxis:{
                tickOptions:{ 
                  angle: -30, formatString: formatoX 
                }, 
                //autoscale:true,
