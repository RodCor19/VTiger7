...
/**
  * BF -  Función para "sumar" string
  * Returns the sum value of all rows passed to it.
  */
  function defaultSummarizeFunctionStr(rows, field){
    /*var runningTotal  = 0,
        i             = -1,
        m             = rows.length;
    while (++i < m) {
    ...
    return runningTotal;*/
    return rows[0][field.dataSource];
  };
      ...
      if (field.summarizeFunction === undefined){
        switch (field.summarizable){
          ...
          case 'avg':
            ...
            break;
          case 'str':
            field.summarizeFunction = defaultSummarizeFunctionStr;
            break;
          default:
